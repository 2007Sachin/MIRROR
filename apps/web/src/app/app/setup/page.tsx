...
export default async function SetupPage() {
  ...
  if (result.status === "unavailable") {
    return <main id="main-content" className="shell py-20"><p role="alert" className="text-sm text-[var(--silver)]">Mirror could not load setup. Refresh to try again.</p></main>;
  }
