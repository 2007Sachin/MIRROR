...
export default async function SetupPage() {
  ...
  if (result.status === "unavailable") {
    return <main id="main-content" className="shell py-20"><p role="alert" className="text-sm text-[var(--silver)]">We couldn't load setup just now. Please refresh and try again.</p></main>;
  }
